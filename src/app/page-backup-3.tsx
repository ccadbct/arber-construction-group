        ...
        <div className="container">
          ...
          <div 
            ...
            <div style={{ flex: '0 0 40%', position: 'relative' }}>
              <Image
                src="/images/homepage/manhattan-coop-galley-kitchen-renovation-upper-east-side.webp"
                alt="Manhattan co-op galley kitchen renovation Upper East Side"
                fill
                style={{ objectFit: 'cover' }}
                loading="lazy"
              />
          ...
          <div 
            ...
            <div style={{ flex: '0 0 40%', position: 'relative' }}>
              <Image
                src="/images/homepage/brooklyn-brownstone-open-concept-renovation-park-slope.webp"
                alt="Brooklyn brownstone open concept renovation Park Slope"
                fill
                style={{ objectFit: 'cover' }}
                loading="lazy"
              />
          ...
          <div 
            ...
            <div style={{ flex: '0 0 40%', position: 'relative' }}>
              <Image
                src="/images/homepage/luxury-queens-apartment-living-room-long-island-city.webp"
                alt="Queens luxury apartment living room Long Island City"
                fill
                style={{ objectFit: 'cover' }}
                loading="lazy"
              />
      ...
      <section style={{
        ...
        <div className="container">
          <div style={{
            ...
            {/* Service Areas - Interactive Coverage Map */}
